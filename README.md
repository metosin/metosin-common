...
[`metosin.testing`](./src/cljc/metosin/testing.cljc) is based on code from
clojure.test, which comes with the following notice:

> Copyright (c) Rich Hickey. All rights reserved. The use and distribution terms
> for this software are covered by the Eclipse Public License 1.0
